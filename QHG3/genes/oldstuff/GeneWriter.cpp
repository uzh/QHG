...
//
int GeneWriter::writeGenes(const char *pFormat, GenomeProvider *pGP, const char *pOutputFile,  const loc_data &mLocData,  const IDSample *pSample, bool bFull, bool bBitNucs) {
    int iResult = 0;
...
//
int GeneWriter::writeGenesPlink(GenomeProvider *pGP, const char *pOutputFile,  const loc_data &mLocDefs,  const IDSample *pSample) {
    int iResult = -1;
...
//
int GeneWriter::writeGenesBin(GenomeProvider *pGP, const char *pOutputFile, const loc_data &mLocDefs,  const IDSample *pSample, bool bFull, bool bBitNucs) {
    int iResult = 0;
...
//    GeneLat       : double    // latitude of genome
//
int GeneWriter::writeGenesAsc(GenomeProvider *pGP, const char *pOutputFile,  const loc_data &mLocDefs,   const IDSample *pSample, bool bFull, bool bBitNucs) {
    int iResult = -1;
...
//    0=A, 1=C, 2=G, 3=T
//
int GeneWriter::writeGenesNum(GenomeProvider *pGP, const char *pOutputFile,   const IDSample *pSample, bool bAddID, bool bBitNucs) {
    int iResult = -1;
