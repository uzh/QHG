...
#ifndef __EQRPROJECTOR_H__
#define __EQRPROJECTOR_H__
...
*   Implementation of a simple equirectangular Projection
*** ***************************************************************************/
class EQRProjector : public Projector {
    
public:
    /** ***************************************************************************\
    *   \fn     EQRProjector(double dLambda0,
    *                        double dPhi) 
    *   \brief  constructor
    *
    ...
    *** ***************************************************************************/
    EQRProjector(double dLambda0, double dPhi0);

    virtual ~EQRProjector(){};
