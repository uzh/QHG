...
OoAConfGen1BPop::OoAConfGen1BPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    m_pNPPCap = new NPPCapacity<OoAConfGen1BAgent>(this, pCG, m_apWELL, m_adCapacities, iCapacityStride); 
    ...
    SingleEvaluator<OoAConfGen1BAgent> *pSEAlt = new SingleEvaluator<OoAConfGen1BAgent>(this, pCG, NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref",true, EVENT_ID_GEO);
    ...
    SingleEvaluator<OoAConfGen1BAgent> *pSECap = new SingleEvaluator<OoAConfGen1BAgent>(this, pCG, NULL, m_adCapacities, "NPPPref", true, EVENT_ID_VEG);
    mEvalInfo.push_back(std::pair<std::string, Evaluator*>("NPPWeight", pSECap));

    m_pME = new MultiEvaluator<OoAConfGen1BAgent>(this, m_pCG, m_adEnvWeights, mEvalInfo, MODE_ADD_SIMPLE, true);  // true: delete evaluators

    OoAConfGen1BAgent agent;
    m_pVerVarK = new VerhulstVarK<OoAConfGen1BAgent>(this, m_pCG, m_apWELL, m_adCapacities, iCapacityStride, (int)qoffsetof(agent, m_iMateIndex));
    ...
    m_pCM = new ConfinedMove<OoAConfGen1BAgent>(this, m_pCG, this->m_vMoveList);
...
// setParams
//
int OoAConfGen1BPop::setParams(const char *pParams) {
    int iResult = 0;
