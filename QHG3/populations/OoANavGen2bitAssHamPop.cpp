...
OoANavGen2bitAssHamPop::OoANavGen2bitAssHamPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    ...
    SingleEvaluator<OoANavGen2bitAssHamAgent> *pSEAlt = new SingleEvaluator<OoANavGen2bitAssHamAgent>(this, pCG, NULL, (double*)m_pCG->m_pGeography->m_adAltitude, "AltCapPref", true, EVENT_ID_GEO);
    ...
    m_pVerVarK = new VerhulstVarK<OoANavGen2bitAssHamAgent>(this, m_pCG, m_apWELL, m_adCapacities, iCapacityStride, (int)qoffsetof(agent, m_iMateIndex));
    ...
    //    m_pCM = new ConfinedMove<OoANavGen2bitAssHamAgent>(this, m_pCG, this->m_vMoveList);
    ...
    m_prio.addAction(ATTR_ASSPAIRHAM_NAME, m_pPair);
...
// setParams
//
int OoANavGen2bitAssHamPop::setParams(const char *pParams) {
    int iResult = 0;
