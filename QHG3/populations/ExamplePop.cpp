...
// constructor
//
ExamplePop::ExamplePop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    : SPopulation<ExampleAgent>(pCG, pPopFinder, iLayerSize, apIDG, aulState, aiSeeds) {
    ...
    m_prio.addAction(ATTR_RANDOMMOVE_NAME,  pRM);
