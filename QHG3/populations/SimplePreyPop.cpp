...
// constructor
//
SimplePreyPop::SimplePreyPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState, uint *aiSeeds) 
    : SPopulation<SimplePreyAgent>(pCG, pPopFinder, iLayerSize, apIDG, aulState, aiSeeds),
      m_afMassArray(NULL),
      m_pRM(NULL),
      m_pMM(NULL),
      m_pVer(NULL) {
