...
AncCapacityPop::AncCapacityPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState) 
    ...
    int iEnvStride = m_pCG->m_iConnectivity + 1;
    m_adEnvWeights = new double[m_pCG->m_iNumCells * iEnvStride];
    ...
    */      
    ...
    m_pVerVarK = new VerhulstVarK<AncCapacityAgent>(this, m_pCG, m_apWELL, m_adEnvWeights, iEnvStride, (int)qoffsetof(agent, m_iMateIndex));
