...
public:
   ...
   ~ParamReader();
    ...
    uint getMandatoryParams(vecstrings &vMand);
    uint getUnknownParams(vecstrings &vUnknown);
    uint getFreeParams(vecstrings &vFree);
...
protected:
    ...
    vecstrings m_vFreeParams;
    vecstrings m_vMissingManadatory;
