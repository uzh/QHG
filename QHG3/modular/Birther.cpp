...
int Birther<T>::tryReadParamLine(char *pLine) {
   ...
   iResult += this->readPopKeyVal(pLine, ATTR_BIRTHER_ADULTMASS_NAME,   &m_dAdultMass);
   iResult += this->readPopKeyVal(pLine, ATTR_BIRTHER_BIRTHMASS_NAME,   &m_dBirthMass);
   iResult += this->readPopKeyVal(pLine, ATTR_BIRTHER_UNCERTAINTY_NAME, &m_dUncertainty);
