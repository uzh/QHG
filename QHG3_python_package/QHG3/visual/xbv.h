...
class ValReader;
//@@ no snap for now  class SnapReader;
class LookUp;
class LookUpFactory;
...
public:
    ...
    /*@@ no snap for now
    int setSnapReader(SnapReader *pSN, LookUp *pLookUp=NULL);
    */
    ...
    /*@@ no snap for now
    SnapReader *getSnapReader() const {return m_pSN;};
    */
...
protected:
    ...
    /*@@ no snap for now
    bool createPNGFromSNAP(char *pName);
    bool createRAWFromSNAP(char *pName);
    */
    ...
    */
    ...
    void destroyOverlay();
    /*@@ no snap foir now
    int snap2qmap(const char *pFileName, int iType, 
                  double dLonMin, double dLonMax, double dDeltaLon,
                  double dLatMin, double dLatMax, double dDeltaLat);
    */
