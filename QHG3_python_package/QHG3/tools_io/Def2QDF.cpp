...
void usage(char *pApp) {
    ...
    printf("  icoline  ::= \"GRID_TYPE ICO\" <ignfile>\n");
    ...
    printf("  altline  ::= \"ALT QMAP\" <altqmap>\n");
    printf("  iceline  ::= \"ICE QMAP\" <iceqmap>\n");
    printf("  templine ::= \"TEMP QMAP\" <tempqmap>\n");
    printf("  rain     ::= \"RAIN QMAP\" <rainqmap>\n");
    printf("  vegline  ::= \"DENS QMAP\" <densqmap>*\n");
    printf("  vegline  ::= \"ANPP QMAP\" <nppqmap>*\n");
    printf("\n");
}
