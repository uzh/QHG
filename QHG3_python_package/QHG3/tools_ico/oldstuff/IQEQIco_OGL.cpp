...
// 
//
IQEQIco_OGL::IQEQIco_OGL(EQsahedron *pEQ, IQOverlay *pOverlay ) 
...
// getCol
//
void IQEQIco_OGL::getCol(gridtype lNode, float fCol[4], float *pfScale) {
    double dVal = dNaN; 
    if (m_pVP != NULL) {
...
//
void IQEQIco_OGL::drawSurfaceLines() {
...
// 
//
void IQEQIco_OGL::drawNodePoints() {
    glBegin(GL_POINTS);
    float fCol[4];
   
    VertexLinkage *pVL = m_pEQ->getLinkage();
...
// drawNodeFacesAlt
//
void IQEQIco_OGL::drawNodeFacesAlt() {
...
// drawNodeFacesFlat
//
void IQEQIco_OGL::drawNodeFacesFlat() {
    glBegin(GL_TRIANGLES);
    int iCount =0;
    ...
    printf("drawNodeFacesFlat() did %d triangles\n", iCount);
...
// drawNodeFaces
//
void IQEQIco_OGL::drawNodeFaces() {
...
void IQEQIco_OGL::drawNodeHex() {
    ...
    printf("drawNodeHex() did %d triangles\n", iCount);
