...
// constructor
//
PDPredPop::PDPredPop(SCellGrid *pCG, PopFinder *pPopFinder, int iLayerSize, IDGen **apIDG, uint32_t *aulState) 
    : SPopulation<PDPredAgent>(pCG, pPopFinder, iLayerSize, apIDG, aulState),
      m_pWM(NULL),
      m_pSE(NULL),
      m_pMM(NULL),
      m_pBB(NULL),
    ...
    m_pSE   = new ShareEvaluator<PDPredAgent>(this, m_pCG, m_adEnvWeights, "PreyMass", true, &g_bUpdateNeededPD);
