...
#define LOTKAVOLTERRA_NAME           "LotkaVolterra"
#define LOTKAVOLTERRA_SELFRATE_NAME  "LV_selfrate"
#define LOTKAVOLTERRA_MIXRATE_NAME   "LV_mixrate"
#define LOTKAVOLTERRA_OTHERPOP_NAME  "LV_otherpop"
#define LOTKAVOLTERRA_K_NAME         "LV_K"
