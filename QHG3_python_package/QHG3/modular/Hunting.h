...
#define HUNTING_NAME       "Hunting"
#define HUNTING_PREYSPECIES_NAME "Hunting_preyspecies"
#define HUNTING_EFFICIENCY_NAME  "Hunting_efficiency"
#define HUNTING_USABILITY_NAME   "Hunting_usability"
